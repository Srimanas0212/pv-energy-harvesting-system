...
The PV cell's voltage and current outputs feed the MPPT control algorithm; PV current is sensed via a small sensing resistor. The model was implemented and validated in the Cadence environment as shown in
[Photovoltaic Cell Model](../images/3.1-PV.png) and the [Output Characteristics of Photovoltaic Cell](../images/3.2-PV_plot.png)
...
Charge is moved between capacitors via switching action, using complementary clock signals for efficient energy transfer as shown in the schematic [Voltage Doubler Circuit](../images/3.3-Doubler.png)
